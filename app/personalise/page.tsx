      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col">
            <div className="w-full h-[400px] rounded-[20px] overflow-hidden mb-6">
              <Image
            ...
            <h3 className="text-brand-gold text-h4 mb-4">Personalise a blank item</h3>
            <p className="text-brand-grey-green text-body mb-6 flex-1">
              Choose from our range of towels, tea towels, tote bags, etc. Perfect for someone special!
            </p>
            <Link href="/custom" className="w-full">
              <Button className="w-full bg-white border-brand-green text-brand-green hover:bg-brand-light-green/20">
          ...
          <div className="flex flex-col">
            ...
            <h3 className="text-brand-gold text-h4 mb-4">Corporate/Bulk Personalisations</h3>
            <p className="text-brand-grey-green text-body mb-6 flex-1">
          ...
          {/* Column 3: Other Personalisations */}
          <div className="flex flex-col">
            <div className="w-full h-[400px] rounded-[20px] overflow-hidden mb-6">
              <Image
            ...
            <h3 className="text-brand-gold text-h4 mb-4">Other Personalisations</h3>
            <p className="text-brand-grey-green text-body mb-6 flex-1">
